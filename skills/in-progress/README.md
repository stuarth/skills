...
- **[through-line](./through-line/SKILL.md)** — Find the through-line of a huge effort instead of making a thousand one-off decisions: distill the principles running through it into a standing `PRINCIPLES.md`, then resolve open questions in batched derivation rounds — principle → scenario → implications → recommendation — that you confirm. User-invoked.
