...
- **[through-line](./through-line/SKILL.md)** — Drive a huge effort from standing principles: distill recurring commitments into `PRINCIPLES.md`, then propagate each verdict through the remaining decisions.
